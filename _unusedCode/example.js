...
const Instauto = require("./functionsLibrary/instaAutoByMifi.js"); //-----
// or:
...
async function instaAutoFunc(app) {
  let browser;
  ...
  try {
    ...
    console.log(`instaAuto.jsondb call finished.`);
